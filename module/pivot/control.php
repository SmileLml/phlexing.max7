...
class pivot extends control
{
     ...
     * @return void
     */
    public function preview($dimensionID = 0, $groupID = 0, $method = '', $params = '')
    {
     ...
     * @return void
     */
    public function versions($groupID, $pivotID, $version = 'newest')
    {
     ...
     */
    public function drillModal($pivotID, $version, $colName, $status, $conditions, $filterValues, $value)
    {
     ...
     * @return void
     */
    public function ajaxGetSysOptions($search = '', $limit = 100)
    {
