        ...
        (
            ...
            (
                ...
                (
                    ...
                    formGroup(setStyle(array('align-items' => 'center')), set::label($lang->message->browserSetting->show), switcher(set::name('show'), set::value(1), set::checked($browserSetting->show))),
                    formGroup(setStyle(array('align-items' => 'center')), set::label($lang->message->browserSetting->count), switcher(set::name('count'), set::value(1), set::checked($browserSetting->count))),
                    formGroup
                    (
                        set::width('5/6'),
