    ...
    (
        ...
        (
            ...
            (
                ...
                inputControl
                (
                    input(set::name('consumed'), set::value(!empty($currentTeam) ? (float)$currentTeam->consumed : $task->consumed), set::disabled((!empty($currentTeam) || $task->isParent) ? true : false)),
            ...
            (
                ...
                inputControl
                (
                    input(set::name('left'), set::value(!empty($currentTeam) ? (float)$currentTeam->left : $task->left), set::disabled($task->isParent ? true : false)),
