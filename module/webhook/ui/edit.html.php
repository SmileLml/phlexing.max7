...
foreach($fields as $field => $attr)
{
    ...
    if($field == 'params' && strpos('|bearychat|dinggroup|dinguser|wechatgroup|wechatuser|feishuuser|feishugroup|', "|{$webhook->type}|") !== false) continue;
    ...
    if($field == 'url' && strpos("|dinguser|wechatuser|feishuuser|", "|{$webhook->type}|") !== false) $rowClass = 'hidden';
