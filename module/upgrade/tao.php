...
class upgradeTao extends upgradeModel
{
     ...
     * @return int
     */
    protected function getDataviewGroupID($name)
    {
     ...
     * @return void
     */
    protected function convertBuiltInDataSet()
    {
     ...
     * @return void
     */
    protected function convertCustomDataSet($customDataset)
    {
        $dataview = new stdclass();
     ...
     * @return string
     */
    protected function getStandardSQLs($version)
    {
     ...
     * @return array
     */
    protected function getFieldsBySQL($sql)
    {
     ...
     * @return string
     */
    protected function changeField($stdLine, $dbLine)
    {
        /* Get configs. */
     ...
     * @return void
     */
    protected function createModules2Workflow()
    {
        $data = new stdclass();
        $data->vision      = 'rnd';
        $data->buildin     = 1;
     ...
     * @return void
     */
    protected function createActions2Workflow()
    {
     ...
     * @return void
     */
    protected function createLayouts2Workflow()
    {
        $data = new stdclass();
     ...
     * @return void
     */
    protected function createProjectDocLib($project)
    {
     ...
     * @return array
     */
    protected function getNoMergedSprints()
    {
     ...
     * @return array
     */
    protected function updateFileObjects($type, $lastID, $limit)
    {
     ...
     * @return void
     */
    protected function updateProjectByProduct($projectID, $productIdList)
    {
     ...
     */
    protected function updateProjectByExecution($projectID, $sprintIdList)
    {
     ...
     * @return void
     */
    protected function moveSprintStoryToProject($projectID, $sprintIdList)
    {
     ...
     * @return void
     */
    protected function moveSprintCaseToProject($projectID, $sprintIdList)
    {
     ...
     * @return void
     */
    protected function moveAllTestTaskToProject($projectID, $sprintIdList)
    {
     ...
     * @return void
     * @param int $programID
     * @param bool $isProjectType
     */
    protected function syncProjectInfoForSprints($projectID, $sprintIdList, $programID, $isProjectType = false)
    {
     ...
     * @return array
     */
    protected function getMaxAndMinDateByAction($projectID, $sprintIdList)
    {
     ...
     * @return void
     */
    protected function updateProjectTime($project, $minRealBegan, $maxRealEnd, $minBeginDate, $maxEndDate, $projectID, $programID)
    {
        $data = new stdClass();
     ...
     * @return void
     */
    protected function setProjectProductsRelation($projectID, $productIdList, $sprintIdList)
    {
     ...
     * @return object
     */
    protected function buildProjectInAutoUpgrade($sprint, $programID, $fromMode, $account, $now)
    {
     ...
     * @return bool
     */
    protected function checkProgramRequired($data, $projectType)
    {
     ...
     * @return string
     */
    protected function getDuplicateProjectName($projectIdList)
    {
