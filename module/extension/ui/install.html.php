...
modalHeader(set::title($title), set::titleClass('font-bold mr-2 '), isset($license) && $upgrade == 'yes' ? to::suffix(sprintf($lang->extension->upgradeVersion, $this->post->installedVersion, $this->post->upgradeVersion)) : null);
