...
$lang->extension->obtainOfficial[2] = '官方認證';
...
$lang->extension->noticeOkFile             = "<p class='font-bold mb-2'>為了安全起見，系統需要確認您的管理員身份</p>
    <p class='font-bold mb-2'>請登錄禪道所在的伺服器，創建%s檔案。</p>
...
$lang->extension->errorPackageFileExists       = '下載路徑已經有一個名為的<strong>%s</strong>附件。<strong>重新%s，<a href="%s" class="alert-link">請點擊此連結</a></strong>';
...
$lang->extension->errorCheckIncompatible       = '該插件與禪道版本不兼容，%s後可能無法使用。<strong>您可以選擇 <a href="#" load-url="%s" onclick="loadUrl(this)" class="btn size-sm">強制%s</a> 或者 <a href="#" load-url="%s" onclick="loadParentUrl(this)" class="btn size-sm">取消</a></strong>';
$lang->extension->errorFileConflicted          = '有以下檔案衝突：<br />%s <strong>您可以選擇 <a href="#" load-url="%s" onclick="loadUrl(this)" class="btn size-sm">覆蓋</a> 或者 <a href="#" load-url="%s" onclick="loadParentUrl(this)" class="btn size-sm">取消</a></strong>';
