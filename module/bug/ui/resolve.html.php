...
formPanel
(
    formGroup(set::width('1/3'), set::label($lang->bug->resolution), set::required(true), picker(set::name('resolution'), set::items($lang->bug->resolutionList), on::change()->toggleClass('#duplicateBugBox', 'hidden', 'target.value !== "duplicate"'))),
    formRow
    (
        setClass('hidden'),
