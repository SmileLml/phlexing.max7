...
$lang->testreport->buildSummary    = '共測試了<strong>%s</strong>個構建。';
$lang->testreport->confirmDelete   = '是否刪除該報告？';
$lang->testreport->moreNotice      = "更多功能可以參考<a href='https://www.zentao.net/page/extension.html' target='_blank'>禪道擴展機制</a>進行擴展，也可以聯繫我們進行定製。";
...
$lang->testreport->foundBugTip     = "影響構建在測試輪次內，並且創建時間在測試時間範圍內產生的Bug數。";
...
$lang->testreport->errorTrunk      = "主幹構建不能創建測試報告，請修改關聯構建！";
...
$lang->testreport->goalTip         = "該構建所屬{$lang->execution->common}的描述信息";
$lang->testreport->runDateTips     = "部分用例執行記錄超出時間範圍（最新時間：%s），未計入測試報告";
$lang->testreport->ignore          = "忽略";

$lang->testreport->bugSummary = <<<EOD
共發現<strong>%s</strong>個Bug <i class='icon icon-help text-light' data-placement='top' data-title="{$lang->testreport->foundBugTip}" data-type='black' data-toggle='tooltip'></i>，
遺留<strong>%s</strong>個Bug <i class='icon icon-help text-light' data-placement='top' data-title="{$lang->testreport->legacyBugTip}" data-type='black' data-toggle='tooltip'></i>。
重新激活<strong>%s</strong>個Bug <i class='icon icon-help text-light' data-placement='top' data-title="{$lang->testreport->activatedBugTip}" data-type='black' data-toggle='tooltip'></i>。
用例執行產生<strong>%s</strong>個Bug <i class='icon icon-help text-light' data-placement='top' data-title="{$lang->testreport->fromCaseBugTip}" data-type='black' data-toggle='tooltip'></i>。
