...
class action extends control
{
     ...
     * @return void
     */
    public function trash($browseType = 'all', $type = 'all', $byQuery = false, $queryID = 0, $orderBy = 'date_desc', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        /* Url存入session。 */
     ...
     * @return void
     */
    public function ajaxGetMoreActions($lastActionID)
    {
