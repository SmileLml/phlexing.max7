...
$lang->action->actioncomment = '備註';
$lang->action->lastComment   = '備註';
...
$lang->action->refusemodule = '還原模組之前，請先還原該模組的父模組';
$lang->action->refusekanban = '還原看板之前，請先還原該看板所屬空間';
...
$lang->action->undeleteModuleTip   = '子目錄恢復後，會同步恢復他的上級目錄，確認要恢復嗎？';
$lang->action->undeleteTaskTip     = '該任務所屬執行已刪除，還原後不能看到該任務，是否繼續還原任務？';
$lang->action->undeleteBoardTip    = '還原白板之前，請先還原該白板的所屬空間。';
$lang->action->undeleteTemplateTip = '該文檔模板的分類（和範圍）已被刪除，確認要同步還原嗎？';
...
$lang->action->objectTypes['build']            = '構建';
$lang->action->objectTypes['projectbuild']     = '項目構建';
...
$lang->action->objectTypes['docspace']         = '文檔空間';
$lang->action->objectTypes['doctemplate']      = '文檔模板';
...
$lang->action->objectTypes['jenkins']          = 'Jenkins伺服器';
$lang->action->objectTypes['nexus']            = 'Nexus伺服器';
...
$lang->action->objectTypes['privpackage']      = '權限包';
...
$lang->action->objectTypes['projectbuild']     = '構建';
$lang->action->objectTypes['board']            = '白板';
$lang->action->objectTypes['boardspace']       = '白板空間';
$lang->action->objectTypes['productline']      = '產品綫';
...
$lang->action->desc->closedbyparent       = '$date, 由系統關閉。' . "\n";
...
$lang->action->desc->editeffort           = '$date, 由 <strong>$actor</strong> 編輯工時。';
...
$lang->action->desc->linked2bug           = '$date 由 <strong>$actor</strong> 關聯到構建 <strong>$extra</strong>';
...
$lang->action->desc->runresult            = '$date, 由 <strong>$actor</strong> 執行%s，結果為 <span class="status-%s font-bold">%s</span>。' . "\n";
...
$lang->action->desc->importedbuild        = '$date, 由 <strong>$actor</strong> 從' . $lang->projectCommon . '構建 <strong>$extra</strong> 導入。' . "\n";
...
$lang->action->desc->createrepobranch     = '$date, 由 <strong>$actor</strong> 創建了代碼分支 <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkrepobranch     = '$date, 由 <strong>$actor</strong> 取消關聯了代碼分支 <strong>$extra</strong>。' . "\n";
$lang->action->desc->changedprogram       = '$date, 由 <strong>$actor</strong> 調整了所屬項目集。' . "\n";
$lang->action->desc->managedteam          = '$date, 由 <strong>$actor</strong> 維護團隊。' . "\n";
$lang->action->desc->syncexecutionteam    = '$date, 同步更新執行增加的團隊成員。' . "\n";
$lang->action->desc->syncprojectteam      = '$date, 同步更新項目刪除的團隊成員。' . "\n";
$lang->action->desc->syncbycase           = '$date, 系統判斷由於執行了用例，將測試單狀態置為進行中。' . "\n";
$lang->action->desc->converttonewdoc      = '$date, 由 <strong>$actor</strong> 完成了文檔轉換。';
...
$lang->action->desc->syncstorybyparenttask = "\$date, 由於父任務更新了相關需求，子任務同步更新。\n";
...
/* 用來描述文檔轉換的操作記錄。*/
$lang->action->desc->convertdoc = '$date, 由 <strong>$actor</strong> 完成文檔轉換 <strong>$extra</strong>。' . "\n";

/* 用來描述文檔模板轉換的操作記錄。*/
$lang->action->desc->convertdoctemplate = '$date, 由 <strong>$actor</strong> 完成文檔模板轉換 <strong>$extra</strong>。' . "\n";
...
$lang->action->desc->adjustcpu               = '$date, 由 <strong>$actor</strong> 調整CPU到 <strong>$newValue</strong> 核。' . "\n";
$lang->action->desc->adjustvol               = '$date, 由 <strong>$actor</strong> 調整磁碟空間到 <strong>$newValue</strong> GB。' . "\n";
...
$lang->action->desc->adjustvolchange         = '$date, 由 <strong>$actor</strong> 修改磁碟空間，從 <strong>$oldValue</strong>GB 修改為 <strong>$newValue</strong>GB。' . "\n";
...
$lang->action->desc->manualbackup        = '$date, 由 <strong>$actor</strong> 手動備份。' . "\n";
$lang->action->desc->autobackup          = '$date, 由 <strong>$actor</strong> 自動備份。' . "\n";
$lang->action->desc->openautobackup      = '$date, 由 <strong>$actor</strong> 開啟自動備份。' . "\n";
$lang->action->desc->closeautobackup     = '$date, 由 <strong>$actor</strong> 關閉自動備份。' . "\n";
$lang->action->desc->autodeletebackups   = '$date, 由 <strong>$actor</strong> 自動刪除備份。' . "\n";
$lang->action->desc->savebackupsettings  = '$date, 由 <strong>$actor</strong> 保存備份設置。' . "\n";
$lang->action->desc->deleteexpiredbackup = '$date, 由 <strong>$actor</strong> 刪除過期備份。' . "\n";
$lang->action->desc->manualdeletebackup  = '$date, 由 <strong>$actor</strong> 手動刪除備份。' . "\n";
...
$lang->action->label->adjustcpu               = '調整了CPU';
$lang->action->label->adjustVol               = '調整了磁碟空間';
...
$lang->action->label->unlinkedfrombuild       = "移除了構建";
...
$lang->action->label->editeffort              = '編輯了工時';
...
$lang->action->label->syncgrade               = '同步了層級';
...
$lang->action->label->syncmultipleproject     = '開始了';
$lang->action->label->startProgram            = "（因{$lang->projectCommon}開始而啟動項目集）";
$lang->action->label->createmr                = '關聯了';
$lang->action->label->deletemr                = '取消了';
$lang->action->label->mergedmr                = '合併了';
...
$lang->action->label->closedbyparent          = '同步關閉了';
...
$lang->action->label->convertdoc              = '轉為新文檔';
$lang->action->label->convertdoctemplate      = '轉為新文檔模板';
...
$lang->action->label->createrepobranch        = '創建了分支從';
$lang->action->label->unlinkrepobranch        = '取消關聯了分支從';
$lang->action->label->communicate             = '溝通了';
$lang->action->label->changedprogram          = '調整了項目集';
...
$lang->action->label->createbackup            = '創建了系統備份';
$lang->action->label->deletebackup            = '刪除了系統備份';
$lang->action->label->restorebackup           = '還原了系統備份';
$lang->action->label->upgradesystem           = '執行了系統升級';
$lang->action->label->system                  = $lang->product->system;
$lang->action->label->manualbackup            = '手動備份了';
$lang->action->label->autobackup              = '自動備份了';
$lang->action->label->openautobackup          = '開啟自動備份';
$lang->action->label->closeautobackup         = '關閉自動備份';
$lang->action->label->autodeletebackups       = '自動刪除備份';
$lang->action->label->savebackupsettings      = '保存備份設置';
$lang->action->label->deleteexpiredbackup     = '刪除過期備份';
$lang->action->label->manualdeletebackup      = '手動刪除備份';
$lang->action->label->syncexecutionteam       = '同步了';
$lang->action->label->syncprojectteam         = '同步了';
$lang->action->label->syncbycase              = '開始了';
$lang->action->label->converttonewdoc         = '轉換了';
...
$lang->action->dynamicAction->story['linked2build']          = "{$lang->SRCommon}關聯構建";
$lang->action->dynamicAction->story['unlinkedfrombuild']     = "構建移除{$lang->SRCommon}";
...
$lang->action->dynamicAction->design['created']   = '創建設計';
$lang->action->dynamicAction->design['changed']   = '變更設計';
$lang->action->dynamicAction->design['confirmed'] = '確認設計';
$lang->action->dynamicAction->design['assigned']  = '指派設計';
$lang->action->dynamicAction->design['deleted']   = '刪除設計';
...
$lang->action->dynamicAction->build['opened']  = '創建構建';
$lang->action->dynamicAction->build['edited']  = '編輯構建';
$lang->action->dynamicAction->build['deleted'] = '刪除構建';
...
$lang->action->dynamicAction->bug['linked2bug']           = 'Bug關聯構建';
$lang->action->dynamicAction->bug['unlinkedfrombuild']    = '構建移除Bug';
...
$lang->action->dynamicAction->nexus['created']   = '創建Nexus伺服器';
$lang->action->dynamicAction->nexus['edited']    = '編輯Nexus伺服器';
$lang->action->dynamicAction->nexus['deleted']   = '刪除Nexus伺服器';
$lang->action->dynamicAction->nexus['undeleted'] = '還原Nexus伺服器';
...
$lang->action->label->build        = '構建|build|view|buildID=%s';
...
$lang->action->label->docspace     = '文檔空間';
$lang->action->label->doc          = '文檔|doc|view|docID=%s';
$lang->action->label->doctemplate  = '文檔模板|doc|view|docID=%s';
...
$lang->action->label->module       = '模組|tree|browse|productid=%s&view=story&currentModuleID=0&branch=all';
...
$lang->action->search->objectTypeList['build']       = '構建';
...
$lang->action->apiTitle->linked2bug            = '關聯到構建 <strong>%s</strong>';
...
$lang->action->apiTitle->unlinkedfrombuild     = "移除構建";
...
$lang->action->desc->mergedmr                     = '$date, 由 <strong>$actor</strong> 合併了代碼';
...
$lang->action->reviewStatusList['wait']      = '待審批';
$lang->action->reviewStatusList['doing']     = '審批中';
$lang->action->reviewStatusList['pass']      = '通過';
$lang->action->reviewStatusList['reject']    = '不通過';
$lang->action->reviewStatusList['reverting'] = '回退中';

$lang->action->reviewResultList['pass']   = '通過';
$lang->action->reviewResultList['reject'] = '不通過';
