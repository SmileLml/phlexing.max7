...
), on::change('#password1, #password, #verifyPassword', 'changePassword'), on::click('button[type="submit"]', 'encryptPassword'), formRowGroup(set::title($lang->my->form->lblBasic)), formRow
(
    formGroup
    (
        set::width('1/2'),
...
), formRowGroup(set::title($lang->my->form->lblAccount)), formRow
(
    formGroup
    (
        set::width('1/2'),
...
), formRowGroup(set::title($lang->my->form->lblContact)), $contacts, formRow
(
    formGroup
    (
        set::width('1/2'),
...
), formRowGroup(set::title($lang->user->verify)), formRow
(
    formGroup
    (
        set::width('1/2'),
...
), formHidden('visions[]', $user->visions), formHidden('passwordLength', 0), formHidden('passwordStrength', 0));
