...
(
    ...
    (
        ...
        (
            ...
            (
                setID('contactTab'),
                tabPane(set::title($lang->my->myContact), set::active(!$isActivePublicList), simpleList(set::items($myContactList))),
                tabPane(set::title($lang->my->publicContact), set::active($isActivePublicList), simpleList(set::items($publicContactList)))
            )
        ),
        divider(),
        cell
