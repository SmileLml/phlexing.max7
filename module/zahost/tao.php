...
class zahostTao extends zahostModel
{
     ...
     * @return bool
     */
    protected function insertImageList($imageList, $hostID, $downloadedImageList)
    {
     ...
     *
     * @param  int         $imageID
     * @param object $statusGroupTasks
     * @access protected
     * @return null|object
     */
    protected function getCurrentTask($imageID, $statusGroupTasks)
    {
        $currentTask = null;
        $finished    = false;
