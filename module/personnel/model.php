...
class personnelModel extends model
{
     ...
     * @return array
     */
    public function getWhitelist($objectID = 0, $objectType = '', $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return bool
     */
    private function updateParentWhitelist($objectType, $objectID, $accounts, $source, $updateType, $deletedAccounts, $objectTable)
    {
     ...
     * @return string
     */
    public function createMemberLink($dept = null, $programID = 0)
    {
     ...
     * @return bool
     */
    public function isClickable($whitelist, $action)
    {
        return true;
    }
     ...
     * @return bool
     */
    public function unbindWhitelist($acl)
    {
