...
foreach($columns as $column)
{
    ...
    (
        ...
        div(setClass('col-item-title flex-1'), $column->parent > 0 ? html("<span class='label gray-pale rounded-xl'>{$lang->kanban->child}</span> $column->name") : $column->name),
        div
        (
