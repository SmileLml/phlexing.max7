...
(
    ...
    (
        ...
        (
            ...
            radioList(set::name('import'), set::items($lang->kanban->importList), set::inline(true), set::value($enableImport))
        )
    ),
    formRow
    (
...
(
    ...
    (
        ...
        to::header(span(setClass('copy-title'), $lang->kanban->copyTitle)),
        div
        (
            setClass('flex items-center'),
            span(setClass('ml-2.5 mr-2'), $lang->kanban->copyContent),
            checkBox
            (
