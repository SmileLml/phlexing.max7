...
(
    ...
    a($browseType == 'my' ? setClass('active') : null, set::href(createLink('product', 'kanban', "browseType=my")), $lang->product->myProduct)
), li
(
    setClass('nav-item item'),
    set::active($browseType == 'other'),
    a($browseType == 'other' ? setClass('active') : null, set::href(createLink('product', 'kanban', "browseType=other")), $lang->product->otherProduct)
));
...
if(empty($kanbanList))
{
    ...
    (
        ...
        (
            ...
            div(setClass('row gap-4 items-center'), span
            (
                setClass('text-gray'),
                $lang->noData
            ))
