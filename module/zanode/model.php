...
class zanodemodel extends model
{
     ...
     * @return int|bool
     */
    public function createImage($zanodeID, $data)
    {
     ...
     * @return false|int
     */
    public function createSnapshot($node, $snapshot)
    {
     ...
     * @return void
     */
    public function editSnapshot($snapshotID, $data)
    {
     ...
     * @return array|bool
     */
    public function update($id, $hostInfo)
    {
     ...
     * @return void
     */
    public function updateImageStatus($imageID, $data)
    {
     ...
     * @return object
     */
    protected function processNodeStatus($node)
    {
     ...
     * @return int|false
     */
    public function setAutomationSetting($object)
    {
     ...
     */
    public function runZTFScript($scriptID = 0, $caseID = 0, $testtaskID = 0)
    {
     ...
     * @return bool
     */
    public static function isClickable($node, $action)
    {
     ...
     * @return bool
     */
    public function checkFields4Create($data)
    {
        /* 检查必填项。*/
     ...
     * @return bool
     */
    public function linkAgentService($data)
    {
