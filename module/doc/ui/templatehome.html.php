        ...
        (
            ...
            (
                ...
                (
                    ...
                    (
                        btn(setClass('size-sm dropdown'), set::type('ghost'), set::icon('ellipsis-v'), set::caret(false)),
                        set::items($actions),
                        set::flip(true),
...
foreach($scopeList as $scope)
{
    ...
    (
        ...
        div(setClass('row items-center justify-between gap-2 px-2.5 py-1 border-b'), div(setClass('row items-center ml-2 flex-none'), div
        (
