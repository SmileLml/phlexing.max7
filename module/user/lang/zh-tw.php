...
$lang->user->passwordfield    = '密碼';
$lang->user->password1        = '密碼';
...
$lang->user->resetPwdByAdmin  = '管理員重置密碼';
$lang->user->resetPwdByMail   = '郵件重置密碼';

$lang->user->abbr = new stdclass();
$lang->user->abbr->id        = '序號';
$lang->user->abbr->password2 = '請重複密碼';
$lang->user->abbr->address   = '地址';
$lang->user->abbr->join      = '入職';
...
$lang->usertpl->account = '創建人';
$lang->usertpl->type    = '模板類型';
$lang->usertpl->title   = '模板名稱';
$lang->usertpl->content = '模板內容';
...
$lang->user->error->account        = '用戶名應該為：三位以上的英文、數字或下劃線的組合';
$lang->user->error->accountDupl    = '用戶名已經存在';
$lang->user->error->realname       = '真實姓名必須填寫';
$lang->user->error->visions        = '界面類型必須填寫';
$lang->user->error->password       = '密碼必須為六位及以上';
$lang->user->error->mail           = '地址不正確';
$lang->user->error->reserved       = '用戶名已被系統預留';
$lang->user->error->weakPassword   = '密碼強度小於系統設定。';
$lang->user->error->dangerPassword = "密碼不能使用【%s】這些常用弱口令。";
...
$lang->user->error->uploadAvatar     = '上傳頭像失敗，請上傳圖片類型的檔案。';
...
$lang->usercontact->account  = '創建人';
$lang->usercontact->listName = '列表名稱';
$lang->usercontact->userList = '用戶列表';
$lang->usercontact->public   = '公共聯繫人';
...
$lang->user->contacts->createList    = '創建聯繫人';
...
$lang->user->jumping = "<span id='time'>10</span>秒鐘後頁面將自動跳轉登錄頁。 <a href='%s' id='redirect' class='btn primary'>立即跳轉</a>";
