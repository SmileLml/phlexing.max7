        ...
        (
            ...
            (
                ...
                (
                    ...
                    h::span(setClass('step-item-id mr-2')),
                    div(html())
                )
            ),
            h::td
                ...
                (
                    ...
                    (
                        ...
                        (
                            setClass('p-0 bd-0'),
                            width('40px'),
                            btn(setClass('ml-2 text-primary'), set::target("#fileModal0"), set('data-toggle', 'modal'), on::click('setFileModalHeight'), set('title', $lang->testtask->files), set::icon('paper-clip'))
                        )
                    )
                )
            )
...
(
    ...
    (
        ...
        h::td(html(nl2br(zget($run->case, 'precondition', ''))))
    )
) : '';
