...
class mrModel extends model
{
     ...
     * @return array
     */
    public function getGitlabProjects($hostID = 0, $projectIdList = array())
    {
     ...
     * @return array
     */
    public function update($MRID, $MR)
    {
     ...
     * @return object|null
     */
    public function apiCreateMR($hostID, $MR)
    {
     ...
     * @return object|null
     */
    public function apiGetSingleMR($repoID, $MRID)
    {
     ...
     * @return object|null
     */
    public function apiUpdateMR($oldMR, $MR)
    {
     ...
     * @return array
     */
    public function getLinkList($MRID, $type, $orderBy = 'id_desc', $pager = null)
    {
     ...
     * @return array
     */
    public function getLinkedMRPairs($objectID, $objectType = 'story', $module = '')
    {
     ...
     * @return bool
     */
    public function link($MRID, $type, $objects)
    {
     ...
     * @return bool
     */
    public function unlink($MRID, $type, $objectID)
    {
        if(!isset($this->config->objectTables[$type])) return false;
     ...
     * @return bool
     */
    public function deleteByID($MRID)
    {
        $MR = $this->fetchByID($MRID);
        if(!$MR) return false;
     ...
     * @return bool
     */
    public function execJob($MRID, $jobID)
    {
