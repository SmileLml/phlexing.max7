        ...
        (
            ...
            (
                ...
                (
                    ...
                    h::tr(h::th($lang->dev->params), h::th($lang->dev->type), h::th($lang->dev->desc)),
...
(
    setClass('bg-white'),
    h::header(setClass('h-10 flex items-center pl-4 flex-none gap-3'), div(setClass('text-lg font-semibold flex items-center'), icon(setClass('pr-2'), 'list'), span($lang->dev->moduleList))),
