...
class programTao extends programModel
{
     ...
     * @return array
     */
    protected function getRootProgramList()
    {
     ...
     * @return array
     */
    protected function buildProgramActionsMap($program)
    {
        if($program->type == 'program' && (!$this->app->user->admin && strpos(",{$this->app->user->view->programs},", ",{$program->id},") === false)) return array();
     ...
     * @return array
     */
    protected function getNormalActions($program)
    {
        $actionsMap    = array();
     ...
     * @return array
     */
    protected function buildProjectActionsMap($project)
    {
     ...
     * @return void
     */
    protected function fixLinkedProduct($programID, $parent, $oldParent, $oldPath)
    {
     ...
     * @return bool
     */
    protected function updateStats($projectIdList)
    {
     ...
     * @return array
     */
    protected function getTaskStats($projectIdList)
    {
     ...
     * @return array
     */
    protected function setNoTaskExecution($projectIdList)
    {
        $summary        = array();
