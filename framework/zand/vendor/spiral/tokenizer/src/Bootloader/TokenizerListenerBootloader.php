    ...
    TokenizerListenerRegistryInterface
{
    ...
    /**
     * @param \Spiral\Boot\AbstractKernel $kernel
     */
    public function boot($kernel)
    {
        $kernel->booted(function (ClassesInterface $classes, ClassesLoaderInterface $loader, ListenerInvoker $invoker) : void {
     ...
     * @param \Spiral\Boot\EnvironmentInterface $env
     * @param \Spiral\Tokenizer\Config\TokenizerConfig $config
     */
    public function initCachedClassesLoader($factory, $dirs, $env, $config)
    {
