...
final class Jobs implements JobsInterface, SerializerAwareInterface
{
     ...
     */
    public function __construct($rpc = null, $serializer = null)
    {
    ...
    /**
     * {@inheritDoc}
     * @param \Spiral\RoadRunner\Jobs\Queue\CreateInfoInterface $info
     */
     ...
     */
    private function toStringOfStringMap($map)
    {
        $marshalled = [];
        ...
        foreach ($map as $key => $value) {
            switch (true) {
                ...
                case \is_array($value):
                    $marshalled[$key] = (string)\json_encode($value, 0);
                    break;
