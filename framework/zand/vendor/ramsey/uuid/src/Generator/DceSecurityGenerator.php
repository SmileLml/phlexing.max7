...
class DceSecurityGenerator implements DceSecurityGeneratorInterface
{
    ...
    /**
     * @var \Ramsey\Uuid\Provider\DceSecurityProviderInterface
     */
    private $dceSecurityProvider;

    /**
     * @param \Ramsey\Uuid\Converter\NumberConverterInterface $numberConverter
     * @param \Ramsey\Uuid\Generator\TimeGeneratorInterface $timeGenerator
     * @param \Ramsey\Uuid\Provider\DceSecurityProviderInterface $dceSecurityProvider
     */
    public function __construct($numberConverter, $timeGenerator, $dceSecurityProvider)
    {
