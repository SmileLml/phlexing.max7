...
class UnixTimeGenerator implements TimeGeneratorInterface
{
    ...
    /**
     * @param \Ramsey\Uuid\Generator\RandomGeneratorInterface $randomGenerator
     * @param int $intSize
     */
    public function __construct($randomGenerator, $intSize = PHP_INT_SIZE)
    {
     ...
     * @inheritDoc
     */
    public function generate($node = null, $clockSeq = null, $dateTime = null)
    {
     ...
     * @param string $time
     */
    private function randomize($time)
    {
        if (self::$seed === null) {
