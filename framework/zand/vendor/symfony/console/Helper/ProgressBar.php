...
final class ProgressBar
{
     ...
     * @param callable(ProgressBar):string $callable A PHP callable
     */
    public function setPlaceholderFormatter(string $name, callable $callable)
    {
     ...
     * @param string $name The placeholder name (including the delimiter char like %)
     */
    public function getPlaceholderFormatter(string $name)
    {
     ...
     */
    public function iterate(iterable $iterable, int $max = null)
    {
     ...
     */
    public function start(int $max = null, int $startAt = 0)
    {
        $this->startTime = time();
        $this->step = $startAt;
