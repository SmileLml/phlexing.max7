...
class Table
{
     ...
     * @param string $cellFormat
     */
    private function renderCell($row, $column, $cellFormat)
    {
        $cell = $row[$column] ?? '';
     ...
     * @param mixed[] $row
     */
    private function getNumberOfColumns($row)
    {
        $columns = \count($row);
     ...
     * @param mixed[] $groups
     */
    private function calculateColumnsWidth($groups)
    {
     ...
     * @param int $column
     */
    private function getCellWidth($row, $column)
    {
        $cellWidth = 0;
