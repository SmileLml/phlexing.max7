...
final class CompletionInput extends ArgvInput
{
     ...
     */
    public static function fromString($inputStr, $currentIndex)
    {
     ...
     * @param int $currentIndex
     */
    public static function fromTokens($tokens, $currentIndex)
    {
     ...
     */
    public function getCompletionName()
    {
     ...
     */
    public function mustSuggestOptionValuesFor($optionName)
    {
     ...
     */
    public function mustSuggestArgumentValuesFor($argumentName)
    {
     ...
     */
    protected function parseToken($token, $parseOptions)
    {
        try {
     ...
     */
    private function getOptionFromToken($optionToken)
    {
     ...
     */
    private function getRelevantToken()
    {
