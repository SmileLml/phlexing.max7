...
final class CompleteCommand extends Command
{
     ...
     */
    public function __construct($completionOutputs = [])
    {
     ...
     * @param \Symfony\Component\Console\Input\InputInterface $input
     */
    private function createCompletionInput($input)
    {
    ...
    /**
     * @param \Symfony\Component\Console\Completion\CompletionInput $completionInput
     * @param \Symfony\Component\Console\Output\OutputInterface $output
     */
    private function findCommand($completionInput, $output)
    {
        try {
