...
final class HttplugWaitLoop
{
     ...
     */
    public function __construct($client, $promisePool, $responseFactory, $streamFactory)
    {
        $this->client = $client;
    ...
    public function wait(?ResponseInterface $pendingResponse, float $maxDuration = null, float $idleTimeout = null)
    {
        if (!$this->promisePool) {
            return 0;
        }
