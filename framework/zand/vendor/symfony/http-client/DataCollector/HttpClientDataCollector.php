...
final class HttpClientDataCollector extends DataCollector implements LateDataCollectorInterface
{
    ...
    /**
     * @param string $name
     * @param \Symfony\Component\HttpClient\TraceableHttpClient $client
     */
     ...
     * @param \Symfony\Component\HttpClient\TraceableHttpClient $client
     */
    private function collectOnClient($client)
    {
     ...
     * @param mixed[] $trace
     */
    private function getCurlCommand($trace)
    {
     ...
     */
    private function argMaxLengthIsSafe($payload)
    {
