...
final class HttplugClient implements ClientInterface, HttpAsyncClient, RequestFactoryInterface, StreamFactoryInterface, UriFactoryInterface, ResetInterface, LegacyHttplugInterface
{
    ...
    /**
     * @var \Symfony\Component\HttpClient\Internal\HttplugWaitLoop
     */
    private $waitLoop;
     ...
     * @param \Psr\Http\Message\RequestInterface $request
     */
    public function sendAsyncRequest($request)
    {
     ...
     */
    public function wait($maxDuration = null, $idleTimeout = null)
    {
     ...
     */
    private function sendPsr7Request($request, $buffer = null)
    {
        try {
