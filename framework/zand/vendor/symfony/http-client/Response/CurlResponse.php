...
final class CurlResponse implements ResponseInterface, StreamableInterface
{
     ...
     * @param \Symfony\Component\HttpClient\Internal\CurlClientState $multi
     * @param mixed[]|null $options
     * @param \Psr\Log\LoggerInterface|null $logger
     * @param string $method
     * @param callable|null $resolveRedirect
     * @param int|null $curlVersion
     * @param string|null $originalUrl
     */
    public function __construct($multi, $ch, $options = null, $logger = null, $method = 'GET', $resolveRedirect = null, $curlVersion = null, $originalUrl = null)
    {
        $this->multi = $multi;
     ...
     * @param \Psr\Log\LoggerInterface|null $logger
     */
    private static function parseHeaderLine($ch, $data, &$info, &$headers, $options, $multi, $id, &$location, $resolveRedirect, $logger)
    {
