...
class MockResponse implements ResponseInterface, StreamableInterface
{
    ...
    /**
     * @var \Symfony\Component\HttpClient\Internal\ClientState
     */
     ...
     * @param string $url
     * @param mixed[] $options
     * @param \Symfony\Contracts\HttpClient\ResponseInterface $mock
     */
    public static function fromRequest($method, $url, $options, $mock)
    {
        $response = new self([]);
     ...
     * @param float $timeout
     */
    protected static function select($multi, $timeout)
    {
        return 42;
    }
     ...
     * @param \Symfony\Contracts\HttpClient\ResponseInterface $mock
     */
    private static function writeRequest($response, $options, $mock)
    {
     ...
     * @param int $offset
     */
    private static function readResponse($response, $options, $mock, &$offset)
    {
        $onProgress = $options['on_progress'] ?? static function () {};
