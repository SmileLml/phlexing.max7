...
final class AsyncContext
{
     ...
     * @param int $offset
     */
    public function __construct(&$passthru, $client, &$response, &$info, $content, $offset)
    {
     ...
     */
    public function createChunk(string $data)
    {
     ...
     */
    public function replaceRequest(string $method, string $url, array $options = [])
    {
     ...
     */
    public function replaceResponse(ResponseInterface $response)
    {
