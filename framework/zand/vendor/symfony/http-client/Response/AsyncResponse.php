...
class AsyncResponse implements ResponseInterface, StreamableInterface
{
     ...
     * @param mixed[] $options
     */
    public function __construct($client, $method, $url, $options, $passthru = null)
    {
        $this->client = $client;
     ...
     */
    public static function stream($responses, $timeout = null, $class = null)
    {
        while ($responses) {
            $wrappedResponses = [];
     ...
     * @param \Symfony\Contracts\HttpClient\HttpClientInterface $client
     * @param $this $r
     * @param \Symfony\Contracts\HttpClient\ChunkInterface $chunk
     */
    private static function passthru($client, $r, $chunk, $asyncMap = null)
    {
        $r->stream = null;
        $response = $r->response;
     ...
     * @param $this $r
     * @param \Symfony\Contracts\HttpClient\ChunkInterface|null $chunk
     */
    private static function passthruStream($response, $r, $chunk, $asyncMap)
    {
        while (true) {
            try {
