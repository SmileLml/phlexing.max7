...
class Gitignore
{
     ...
     * @param string $gitignoreFileContent
     */
    public static function toRegexMatchingNegatedPatterns($gitignoreFileContent)
    {
     ...
     * @param bool $inverted
     */
    private static function buildRegex($gitignoreFileContent, $inverted)
    {
    ...
    private static function lineToRegex($gitignoreLine)
    {
        ...
        return ($isAbsolute ? '' : '(?:[^/]+/)*')
            .$regex
            .(substr_compare($gitignoreLine, '/', -strlen('/')) !== 0 ? '(?:$|/)' : '');
    }
}
