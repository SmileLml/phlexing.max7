...
class Inline
{
     ...
     * @param int                          $flags A bit field of Yaml::DUMP_* constants to customize the dumped YAML string
     */
    private static function dumpHashArray($value, $flags)
    {
        $output = [];
        foreach ($value as $key => $val) {
     ...
     * @param int $flags
     */
    private static function dumpNull($flags)
    {
     ...
     */
    public static function parseScalar($scalar, $flags = 0, $delimiters = null, &$i = 0, $evaluate = true, &$references = [], &$isQuoted = null)
    {
     ...
     * @param int $i
     */
    private static function parseQuotedScalar($scalar, &$i = 0)
    {
     ...
     * @param int $flags
     * @param mixed[] $references
     * @param bool|null $isQuotedString
     */
    private static function evaluateScalar($scalar, $flags, &$references = [], &$isQuotedString = null)
    {
