...
class Dumper
{
     ...
     */
    public function dump($input, int $inline = 0, int $indent = 0, int $flags = 0)
    {
        $output = '';
    ...
    /**
     * @param \Symfony\Component\Yaml\Tag\TaggedValue $value
     * @param int $inline
     * @param int $indent
     * @param int $flags
     * @param string $prefix
     */
    private function dumpTaggedValue($value, $inline, $indent, $flags, $prefix)
    {
     ...
     * @param string $value
     */
    private function getBlockIndentationIndicator($value)
    {
        $lines = explode("\n", $value);
