...
class LintCommand extends Command
{
     ...
     * @param callable|null $directoryIteratorProvider
     * @param callable|null $isReadableProvider
     */
...
EOF
     ...
     * @param mixed[] $files
     */
    private function display($io, $files)
    {
        switch ($this->format) {
            case 'txt':
     ...
     */
    private function displayTxt($io, $filesInfo, $errorAsGithubAnnotations = false)
    {
     ...
     * @param mixed[] $filesInfo
     */
    private function displayJson($io, $filesInfo)
    {
        $errors = 0;
    ...
    private function getAvailableFormatOptions()
    {
