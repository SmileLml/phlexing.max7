...
class Parser
{
     ...
     * @param int $cursor
     */
    private function lexInlineQuotedString(&$cursor = 0)
    {
     ...
     * @param int $cursor
     */
    private function lexUnquotedString(&$cursor)
    {
        $offset = $cursor;
     ...
     * @param int $cursor
     */
    private function lexInlineMapping(&$cursor = 0)
    {
     ...
     * @param int $cursor
     */
    private function lexInlineSequence(&$cursor = 0)
    {
        return $this->lexInlineStructure($cursor, ']');
    }
     ...
     */
    private function lexInlineStructure(&$cursor, $closingTag)
    {
        $value = $this->currentLine[$cursor];
        ++$cursor;
     ...
     * @param int $cursor
     */
    private function consumeWhitespaces(&$cursor)
    {
