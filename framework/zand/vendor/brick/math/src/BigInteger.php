...
final class BigInteger extends BigNumber
{
     ...
     * @psalm-pure
     */
    public static function fromArbitraryBase($number, $alphabet)
    {
        if ($number === '') {
            throw new NumberFormatException('The number cannot be empty.');
        }
     ...
     */
    public static function fromBytes($value, $signed = true)
    {
        if ($value === '') {
     ...
     */
    public static function randomBits($numBits, $randomBytesGenerator = null)
    {
        if ($numBits < 0) {
    ...
    /**
     * @param \Brick\Math\BigInteger $a
     * @param \Brick\Math\BigInteger ...$n
     */
    public static function gcdMultiple($a, ...$n)
    {
        $result = $a;
     ...
     */
    public function modPow($exp, $mod)
    {
     ...
     * @param int $distance
     */
    public function shiftedLeft($distance)
    {
        if ($distance === 0) {
            return $this;
        }
     ...
     * @param int $distance
     */
    public function shiftedRight($distance)
    {
        if ($distance === 0) {
            return $this;
        }
     ...
     */
    public function toArbitraryBase($alphabet)
    {
        $base = \strlen($alphabet);
     ...
     */
    public function toBytes($signed = true)
    {
