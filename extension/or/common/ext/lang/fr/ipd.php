...
$lang->demandpool->menu->demand = array('link' => "Demand|demand|browse|poolID=%s", 'alias' => 'managetree,tostory');
...
$lang->charter->menu->reviewing = array('link' => "Reviewing|charter|browse|browseType=reviewing");
$lang->charter->menu->launched  = array('link' => "Launched|charter|browse|browseType=launched");
$lang->charter->menu->completed = array('link' => "Completed|charter|browse|browseType=completed");
$lang->charter->menu->canceled  = array('link' => "Canceled|charter|browse|browseType=canceled");
$lang->charter->menu->closed    = array('link' => "Closed|charter|browse|browseType=closed");
...
$lang->my->menu->contribute['subMenu']->demand      = array('link' => "Demand|my|contribute|mode=demand", 'alias' => 'demand');
$lang->my->menu->contribute['subMenu']->requirement = array('link' => "$lang->URCommon|my|contribute|mode=requirement", 'alias' => 'requirement');
$lang->my->menu->contribute['subMenu']->task        = array('link' => "Task|my|contribute|mode=task", 'alias' => 'task');
...
$lang->market->menu->research = array('link' => "Research|marketresearch|browse|marketID=%s", 'subModule' => 'marketresearch,researchtask', 'exclude' => 'marketresearch-reports');
