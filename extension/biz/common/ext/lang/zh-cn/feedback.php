...
$lang->feedback->menu->browse   = array('link' => '反馈|feedback|admin|browseType=wait', 'alias' => 'create,batchcreate,edit,view,adminview,batchedit,browse,showimport,batchclose,tostory,touserstory,toepic,totodo,todemand');
...
{
    $lang->feedback->menu->browse = array('link' => '反馈|feedback|browse|browseType=unclosed', 'alias' => 'create,batchcreate,edit,view,adminview,batchedit,browse,admin,batchclose');
