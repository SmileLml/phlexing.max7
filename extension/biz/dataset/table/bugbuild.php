...
$schema->objects['execution']['id']   = array('type' => 'number', 'name' => $this->lang->dataset->id);
...
$schema->objects['module']['id']   = array('type' => 'number', 'name' => $this->lang->dataset->id);
$schema->objects['module']['name'] = array('type' => 'string', 'name' => $this->lang->tree->module);

$schema->objects['testcase'] = array();
$schema->objects['testcase']['id']    = array('type' => 'number', 'name' => $this->lang->dataset->id);
