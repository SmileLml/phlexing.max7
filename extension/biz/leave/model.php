...
class leaveModel extends model
{
     ...
     * @return array
     */
    public function processStatus($leaveList, $record = null)
    {
    ...
    public function reviewBackDate($id, $status)
    {
        ...
        if($oldLeave->end > $leave->end)
        {
            ...
            $this->loadModel('attend')->batchUpdate($oldDates, $leave->createdBy);
        }
    ...
    public function savePersonalAnnual()
    {
        ...
        if($totalAnnuals) $this->loadModel('setting')->setItems('system.leave', $data);
        return !dao::isError();
    }
