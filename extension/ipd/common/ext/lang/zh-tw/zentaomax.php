...
$lang->reviewcl->clcategory       = '檢查單分類';
...
$lang->my->menu->contribute['subMenu']->myAudit  = array('link' => '審計|my|contribute|mode=myAudit&type=auditByMe', 'alias' => 'myaudit');
$lang->my->menu->contribute['subMenu']->baseline = array('link' => '基線|my|contribute|mode=baseline&type=createdBy', 'alias' => 'baseline');
...
$lang->project->noMultiple->scrum->menu->other['dropMenu']->issue       = array('link' => '問題|issue|browse|projectID=%s', 'subModule' => 'issue');
$lang->project->noMultiple->scrum->menu->other['dropMenu']->risk        = array('link' => '風險|risk|browse|projectID=%s', 'subModule' => 'risk');
$lang->project->noMultiple->scrum->menu->other['dropMenu']->opportunity = array('link' => "機會|opportunity|browse|projectID=%s", 'subModule' => 'opportunity');
$lang->project->noMultiple->scrum->menu->other['dropMenu']->pssp        = array('link' => '過程|pssp|browse|projectID=%s&from=project', 'subModule' => 'pssp', 'data-app' => 'project');
...
$lang->project->noMultiple->scrum->menu->other['dropMenu']->meeting     = array('link' => '會議|meeting|browse|projectID=%s', 'subModule' => 'meeting');

$lang->project->noMultiple->scrum->menu->auditplan['subMenu'] = new stdclass();
$lang->project->noMultiple->scrum->menu->auditplan['subMenu']->auditplan = array('link' => '質量保證計劃|auditplan|browse|project=%s&from=project', 'alias' => 'create,batchcreate,edit,batchcheck,batchedit');
...
$lang->workflow->menu->approval = array('link' => '審批流|approvalflow|browse|', 'subModule' => 'approvalflow,approvalrole');
