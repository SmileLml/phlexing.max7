...
$lang->install->successLabel       = "<p>You have installed ZenTao IPD%s.</p>";
$lang->install->successNoticeLabel = "<p>You have installed ZenTao IPD%s.<strong class='text-danger'> Please delete install.php</strong>.</p>";
