...
$config->workflowfield->require->edit   = 'name, control';
...
$config->workflowfield->hasDelayModules   = array('project', 'execution', 'task', 'bug');
$config->workflowfield->hiddenPlaceholder = array('radio', 'checkbox', 'file');
...
$config->workflowfield->numberTypes = array_merge(array_keys($config->workflowfield->typeList['integer']), array_keys($config->workflowfield->typeList['decimal']), array('float'));
...
$config->workflowfield->default->fields['program']      = 'mediumint(8) unsigned NOT NULL DEFAULT 0';
$config->workflowfield->default->fields['product']      = 'mediumint(8) unsigned NOT NULL DEFAULT 0';
$config->workflowfield->default->fields['project']      = 'mediumint(8) unsigned NOT NULL DEFAULT 0';
$config->workflowfield->default->fields['execution']    = 'mediumint(8) unsigned NOT NULL DEFAULT 0';
...
$config->workflowfield->default->fields['mailto']       = "text NULL";
...
$config->workflowfield->default->fieldTypes['program']      = 'mediumint';
$config->workflowfield->default->fieldTypes['product']      = 'mediumint';
$config->workflowfield->default->fieldTypes['project']      = 'mediumint';
$config->workflowfield->default->fieldTypes['execution']    = 'mediumint';
...
$config->workflowfield->default->fieldLength['program']      = '8';
$config->workflowfield->default->fieldLength['product']      = '8';
$config->workflowfield->default->fieldLength['project']      = '8';
$config->workflowfield->default->fieldLength['execution']    = '8';
...
$config->workflowfield->default->controls['program']      = 'select';
$config->workflowfield->default->controls['product']      = 'select';
$config->workflowfield->default->controls['project']      = 'select';
$config->workflowfield->default->controls['execution']    = 'select';
...
$config->workflowfield->default->options['program']    = 'program';
$config->workflowfield->default->options['product']    = 'product';
$config->workflowfield->default->options['project']    = 'project';
$config->workflowfield->default->options['execution']  = 'execution';
...
$config->workflowfield->default->buildin['program']   = 1;
$config->workflowfield->default->buildin['product']   = 1;
$config->workflowfield->default->buildin['project']   = 1;
$config->workflowfield->default->buildin['execution'] = 1;
...
$config->workflowfield->approval->fields['reviewers']     = "text NULL";
$config->workflowfield->approval->fields['reviewOpinion'] = "text NULL";
$config->workflowfield->approval->fields['reviewStatus']  = "varchar(10) NOT NULL DEFAULT 'wait'";
$config->workflowfield->approval->fields['reviewResult']  = "varchar(10) NOT NULL DEFAULT ''";
$config->workflowfield->approval->fields['approval']      = 'mediumint(8) unsigned NOT NULL DEFAULT 0';
...
$config->workflowfield->approval->values['reviewStatus'] = 'wait';
$config->workflowfield->approval->values['approval']     = '0';
