...
$lang->system->menu->todo    = array('link' => 'Calendar|company|todo|');
...
$lang->execution->menu->view['subMenu']->taskeffort = array('link' => 'Task Effort|execution|taskeffort|executionID=%s');
