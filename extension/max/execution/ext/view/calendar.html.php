...
$(function()
{
    ...
    var calendar = $calendar.calendar(
    {
        ...
        {
            var $event = $('<div title="' + event.divTitle + '" data-id="' + (event.id || '') + '" class="event" title="' + (event.desc || '') + '"><span class="status-' + event.status + '">' + ' <span class="label label-dot"></span></span> <span class="title">' + (event.iconTitle ? event.iconTitle : event.title) + '</span></div>');
            return $event;
        },
