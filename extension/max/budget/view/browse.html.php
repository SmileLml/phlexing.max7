...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    <?php $canModify = common::canModify('project', $project);?>
    <?php $canModify ? common::printLink('budget', 'batchcreate', "projectID=$projectID", "<i class='icon icon-plus'></i>" . $lang->budget->batchCreate, '', "class='btn btn-secondary'") : null;?>
    <?php $canModify ? common::printLink('budget', 'create', "projectID=$projectID", "<i class='icon icon-plus'></i>" . $lang->budget->create, '', "class='btn btn-primary'") : null;?>
  </div>
</div>
  ...
  <div class="main-col">
    ...
    <div class="table-empty-tip">
      <p>
        ...
        <?php if($canModify && common::hasPriv('budget', 'create')):?>
