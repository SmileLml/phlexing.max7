...
class measurement extends control
{
    ...
    public function template($type = 'complex', $recTotal = 0, $recPerPage = 20, $pageID = 1)
    {
        ...
        if($type == 'single')
        {
            ...
            $this->session->set('reportList', $this->app->getURI(true), 'admin');
        }
    ...
    public function setSQL($measurementID)
    {
        ...
        $this->view->title         = $this->lang->measurement->design . $this->lang->hyphen . $measurement->name;
    ...
    public function setTips($type = 'progress', $object = 'SPI')
    {
        ...
        $this->view->title      = $this->lang->custom->common . $this->lang->hyphen . $this->lang->custom->setTips;
    ...
    public function batchEdit()
    {
        ...
        $this->view->title      = $this->lang->measurement->common . $this->lang->hyphen . $this->lang->measurement->batchEdit;
