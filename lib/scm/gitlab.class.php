...
class gitlabRepo
{
     ...
     * @return array
     */
    public function tags($showDetail = '', $revision = 'HEAD', $onlyDir = true, $orderBy = '', $limit = 0, $pageID = 1)
    {
     ...
     * @return array
     */
    public function branch($showDetail = '', $orderBy = '', $limit = 0, $pageID = 1)
    {
     ...
     * @return string
     */
    public function getApiUrl($target)
    {
        if($target == 'project')
        {
