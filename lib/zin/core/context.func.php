...
function onBuildNode($callback)
{
    return context::current()->onBuildNode($callback);
}

function onRenderNode($callback)
{
    return context::current()->onRenderNode($callback);
}

function onBeforeBuildNode($callback)
{
...
/**
 * @param mixed $nameOrData
 * @param mixed ...$values
 */
function d($nameOrData, ...$values)
{
