...
class CLI
{
     ...
     */
    public function usageHighlight($isStandalone = true)
    {
     ...
     * @param bool $isStandalone
     */
    public function runHighlight($isStandalone = true)
    {
     ...
     * @param bool $isStandalone
     */
    public function usageLint($isStandalone = true)
    {
     ...
     * @param bool $isStandalone
     */
    public function runLint($isStandalone = true)
    {
     ...
     * @param bool $isStandalone
     */
    public function usageTokenize($isStandalone = true)
    {
     ...
     * @param bool $isStandalone
     */
    public function runTokenize($isStandalone = true)
    {
