...
class LockExpression extends Component
{
     ...
     */
    public static function parse($parser, $list, $options = [])
    {
        $ret = new static();
     ...
     * @return string
     */
    public static function build($component, $options = [])
    {
    ...
    /**
     * @return string
     * @param \PhpMyAdmin\SqlParser\Parser $parser
     * @param \PhpMyAdmin\SqlParser\TokensList $list
     */
