...
abstract class AbstractPart
{
     ...
     */
    abstract public function read($phpWord);
     ...
     */
    protected function readParagraph($xmlReader, $domNode, $parent, $docPart = 'document')
    {
        // Paragraph style
        $paragraphStyle = null;
        $headingDepth = null;
     ...
     * @return number|null
     */
    private function getHeadingDepth($paragraphStyle = null)
    {
     ...
     */
    protected function readRun($xmlReader, $domNode, $parent, $docPart, $paragraphStyle = null)
    {
     ...
     */
    protected function readRunChild($xmlReader, $node, $parent, $docPart, $paragraphStyle = null, $fontStyle = null)
    {
     ...
     * @param string $docPart
     */
    protected function readTable($xmlReader, $domNode, $parent, $docPart = 'document')
    {
        // Table style
        $tblStyle = null;
     ...
     * @return array|null
     */
    protected function readParagraphStyle($xmlReader, $domNode)
    {
        if (!$xmlReader->elementExists('w:pPr', $domNode)) {
            return null;
        }
     ...
     * @return array|null
     */
    protected function readFontStyle($xmlReader, $domNode)
    {
        if (is_null($domNode)) {
            return null;
        }
     ...
     */
    protected function readTableStyle($xmlReader, $domNode)
    {
        $style = null;
     ...
     * @return array
     */
    private function readTablePosition($xmlReader, $domNode)
    {
        $styleDefs = array(
     ...
     */
    private function readTableIndent($xmlReader, $domNode)
    {
        $styleDefs = array(
     ...
     * @return array
     */
    private function readCellStyle($xmlReader, $domNode)
    {
        $styleDefs = array(
     ...
     * @return string|null
     */
    private function findPossibleElement($xmlReader, $parentNode = null, $elements = null)
    {
     ...
     * @return string|null
     */
    private function findPossibleAttribute($xmlReader, $node, $attributes)
    {
     ...
     * @return array
     */
    protected function readStyleDefs($xmlReader, $parentNode = null, $styleDefs = array())
    {
        $styles = array();
