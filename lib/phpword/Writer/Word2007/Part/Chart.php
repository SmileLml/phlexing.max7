...
class Chart extends AbstractPart
{
     ...
     */
    private function writeChart($xmlWriter)
    {
     ...
     * @param \PhpOffice\PhpWord\Shared\XMLWriter $xmlWriter
     */
    private function writePlotArea($xmlWriter)
    {
     ...
     * @param bool $scatter
     */
    private function writeSeries($xmlWriter, $scatter = false)
    {
     ...
     * @param array $values
     */
    private function writeSeriesItem($xmlWriter, $type, $values)
    {
        $types = array(
     ...
     * @param string $type
     */
    private function writeAxis($xmlWriter, $type)
    {
        $style = $this->element->getStyle();
        $types = array(
     ...
     * @param bool $line
     */
    private function writeShape($xmlWriter, $line = false)
    {
        $xmlWriter->startElement('c:spPr');
     ...
     * @param \PhpOffice\PhpWord\Shared\XMLWriter $xmlWriter
     */
    private function writeAxisTitle($xmlWriter, $title)
    {
