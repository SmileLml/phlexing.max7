...
class Html
{
    ...
    protected static function parseNode($node, $element, $styles = array(), $data = array())
    {
        ...
        $nodes = array(
            ...
            'del'         => array('Property',    null,   null,       $styles,    null,   'strikethrough',    true),
            'strike'         => array('Property',    null,   null,       $styles,    null,   'strikethrough',    true),
     ...
     */
    protected static function shouldAddTextRun($node)
    {
     ...
     * @param mixed[] $style
     */
    protected static function recursiveParseStylesInHierarchy($node, $style)
    {
        $parentStyle = array();
     ...
     * @param array &$styles
     */
    protected static function filterOutNonInheritedStyles($styles)
    {
