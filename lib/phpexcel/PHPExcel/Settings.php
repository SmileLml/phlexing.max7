...
class PHPExcel_Settings
{
    ...
    public static function setLibXmlLoaderOptions($options = null)
    {
        ...
        if(PHP_VERSION_ID < 80000) @libxml_disable_entity_loader($options == (LIBXML_DTDLOAD | LIBXML_DTDATTR));
    ...
    public static function getLibXmlLoaderOptions()
    {
        ...
        if(PHP_VERSION_ID < 80000) @libxml_disable_entity_loader(self::$_libXmlLoaderOptions == (LIBXML_DTDLOAD | LIBXML_DTDATTR));
