...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
  ...
  */
 private function _extendRowsForChartsAndImages($pSheet, $row) {
		$rowMax = $row;
		$colMax = 'A';
	 ...
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _writeImageInCell($pSheet, $coordinates) {
		// Construct HTML
		$html = '';
	 ...
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _writeChartInCell($pSheet, $coordinates) {
		// Construct HTML
		$html = '';
	 ...
	 * @return	array
	 */
	private function _createCSSStyle($pStyle) {
		// Construct CSS
		$css = '';
	 ...
	 * @return	array
	 */
	private function _createCSSStyleAlignment($pStyle) {
		// Construct CSS
		$css = array();
	 ...
	 * @return	array
	 */
	private function _createCSSStyleFont($pStyle) {
		// Construct CSS
		$css = array();
	 ...
	 * @return	array
	 */
	private function _createCSSStyleBorders($pStyle) {
		// Construct CSS
		$css = array();
	 ...
	 * @return	string
	 */
	private function _createCSSStyleBorder($pStyle) {
		// Create CSS
//		$css = $this->_mapBorderStyle($pStyle->getBorderStyle()) . ' #' . $pStyle->getColor()->getRGB();
	 ...
	 * @return	array
	 */
	private function _createCSSStyleFill($pStyle) {
		// Construct HTML
		$css = array();
	 ...
	 * @throws	PHPExcel_Writer_Exception
	 */
	private function _generateRow($pSheet, $pValues = null, $pRow = 0) {
		if (is_array($pValues)) {
			// Construct HTML
			$html = '';
  ...
  * @param \PHPExcel_Worksheet $pSheet
  */
 private function _setMargins($pSheet) {
		$htmlPage = '@page { ';
		$htmlBody = 'body { ';
