...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 */
	public function writeChart($pChart = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeTitle($title = null, $objWriter = null)
	{
		if (is_null($title)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLegend($legend = null, $objWriter = null)
	{
		if (is_null($legend)) {
			return;
		}
  ...
  */
 private function _writePlotArea($plotArea,
									$xAxisLabel = NULL,
									$yAxisLabel = NULL,
									$objWriter = null,
									$pSheet = null)
...
//					} while ($id1 == $id2);
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCatAx($objWriter, $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeValAx($objWriter, $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
  ...
  * @param \PHPExcel_Worksheet $pSheet
  */
 private function _writeBubbles($plotSeriesValues, $objWriter, $pSheet)
	{
		if (is_null($plotSeriesValues)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLayout($layout = NULL, $objWriter = null)
	{
