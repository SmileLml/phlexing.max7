...
class PHPExcel_Writer_Excel2007_Comments extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeComment($objWriter = null, $pCellReference = 'A1', $pComment = null, $pAuthors = null)
	{
		// comment
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeVMLComment($objWriter = null, $pCellReference = 'A1', $pComment = null)
	{
 		// Metadata
