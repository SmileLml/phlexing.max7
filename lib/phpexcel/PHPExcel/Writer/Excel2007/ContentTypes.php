...
class PHPExcel_Writer_Excel2007_ContentTypes extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefaultContentType($objWriter = null, $pPartname = '', $pContentType = '')
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeOverrideContentType($objWriter = null, $pPartname = '', $pContentType = '')
	{
		if ($pPartname != '' && $pContentType != '') {
			// Write content type
