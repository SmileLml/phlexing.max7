...
class PHPExcel_Writer_Excel2007_Drawing extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 */
	public function writeDrawings($pWorksheet = null, &$chartRef = 0, $includeCharts = FALSE)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeChart($objWriter = null, $pChart = null, $pRelationId = -1)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeDrawing($objWriter = null, $pDrawing = null, $pRelationId = -1)
	{
		if ($pRelationId >= 0) {
			// xdr:oneCellAnchor
...
*/
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function _writeVMLHeaderFooterImage($objWriter = null, $pReference = '', $pImage = null)
	{
		// Calculate object id
