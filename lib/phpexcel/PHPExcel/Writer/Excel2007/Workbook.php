...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCalcPr($objWriter = null, $recalcRequired = TRUE)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeSheet($objWriter = null, $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible')
	{
		if ($pSheetname != '') {
			// Write sheet
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeNamedRanges($objWriter = null, $pPHPExcel = null)
	{
		// Loop named ranges
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForNamedRange($objWriter = null, $pNamedRange = null)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForAutofilter($objWriter = null, $pSheet = null, $pSheetId = 0)
	{
		// definedName for autoFilter
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintTitles($objWriter = null, $pSheet = null, $pSheetId = 0)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintArea($objWriter = null, $pSheet = null, $pSheetId = 0)
	{
