...
ALTER TABLE `zt_im_message` CHANGE `contentType` `contentType` ENUM('text', 'plain', 'emotion', 'image', 'file', 'code', 'object')  CHARACTER SET utf8mb4  COLLATE utf8_general_ci  NOT NULL  DEFAULT 'text';
